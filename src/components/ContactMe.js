...
export default function ContactMe() {
  ...
  return (
    <div  id='about' className='d-flex justify-content-center text-center align-items-center flex-wrap ' style={{ padding: '80px 80px 80px 80px' }} >
      <h2 className='fw-bold greet' style={styles}>
          Stay in Touch
      </h2>
      <div>
        <StyledWrapper>
          <ul className="example-2">
            <li className="icon-content">
              <a href="https://www.linkedin.com/in/khetrabasi-reddy-b0ba77224/" aria-label="LinkedIn" data-social="linkedin" target='_blank'>
            ...
            <li className="icon-content">
              <a href="https://github.com/KhetrabasiReddy" aria-label="GitHub" data-social="github" target='_blank'>
                <div className="filled" />
